...
/// <summary>
///     A code fix provider that replaces calls to <see cref="object.ToString"/> with
///     the <c>Ts</c> shorthand method.
/// </summary>
...
public class ToStringCodeFixProvider : CodeFixProvider
{
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        context.RegisterCodeFix(
            CodeAction.Create(
                title: Resources.HN0001CodeFixTitle,
                createChangedDocument: c => UseShorthandAsync(context.Document, invocation, c),
                equivalenceKey: nameof(Resources.HN0001CodeFixTitle)),
            diagnostic);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var newMemberAccess = memberAccess.WithName(
            SyntaxFactory.IdentifierName("Ts").WithTriviaFrom(memberAccess.Name));
